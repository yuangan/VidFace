    ...
    def dist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        for idx in range(rank, len(dataset), world_size):
            ...
            if save_img:
                ...
                # assert(0)# print('save to /home/wei/gy/EDVR/flow_save_160/mask.npy')
                # np.save('/home/wei/gy/EDVR/flow_save_160/offset.npy', visuals['flow'])
                # np.save('/home/wei/gy/EDVR/flow_save_160/mask.npy', visuals['mask'])
