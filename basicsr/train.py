...
from basicsr.utils import (MessageLogger, check_resume, get_env_info,
                           ...
                           make_exp_dirs, mkdir_and_rename, set_random_seed, modelsize)
...
#         opt['manual_seed'] = seed
    ...
    # gpu_tracker.track()
    # size
    # sample_rand = torch.rand(7, 3, 16, 12).to(torch.cuda.current_device())
    # modelsize(model.net_g, sample_rand)
    ...
    for epoch in range(start_epoch, total_epochs + 1):
        ...
        while train_data is not None:
            ...
            if (opt['val']['val_freq'] is not None and current_iter % opt[
                    'val']['val_freq'] == 0) or current_iter == 200:
